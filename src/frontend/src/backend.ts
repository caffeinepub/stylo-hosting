...
import type { ExternalBlob as _ExternalBlob, Site as _Site, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addSite(arg0: string, arg1: ExternalBlob): Promise<SiteId> {
        if (this.processError) {
            try {
                const result = await this.actor.addSite(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCallerSites(): Promise<Array<Site>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCallerSites();
    ...
    async getAllSiteIds(): Promise<Array<SiteId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSiteIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerSitesWithIds(): Promise<Array<SiteWithId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerSitesWithIds();
                return await from_candid_vec_siteWithId(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getSite(arg0: SiteId): Promise<[string, Site]> {
        if (this.processError) {
            try {
                const result = await this.actor.getSite(arg0);
                return [
                    result[0],
                    from_candid_Site_n12(this._uploadFile, this._downloadFile, result[1])
                ];
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSiteFile(arg0: SiteId): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.getSiteFile(arg0);
...
async function from_candid_Site_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Site): Promise<Site> {
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Site>): Promise<Array<Site>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Site_n12(_uploadFile, _downloadFile, x)));
}
...
async function from_candid_vec_siteWithId(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<{ id: bigint; name: string; blobId: Uint8Array }>): Promise<Array<SiteWithId>> {
    return await Promise.all(value.map(async (x) => ({
        id: x.id,
        name: x.name,
        blobId: await _downloadFile(x.blobId)
    })));
}
